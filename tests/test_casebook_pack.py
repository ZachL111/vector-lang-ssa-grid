"""Regression checks for the vector-lang-ssa-grid casebook."""
...
from casebook.harness import assert_expected, vector_lang_ssa_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vector_lang_ssa_grid_summary(), assert_expected())
