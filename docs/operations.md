...
`vector-lang-ssa-grid` is centered on compilers work in Julia. The technical target is: Create a Julia reference implementation for ssa workflows, centered on event replay, fixture event logs, and golden state snapshots.
...
The score is deterministic. The current threshold is 176. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 5.
